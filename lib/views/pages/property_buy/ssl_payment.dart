...
import 'package:home_land/views/pages/property_buy/property_buy_final_step/congratilatons_screen.dart';
                ...
                Column(
                  children: [
                    Padding(
                      ...
                      child: TextFormField(
                        initialValue: "futur63e91854740f5",
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: TextFormField(
                        initialValue: "futur63e91854740f5@ssl",
                        keyboardType: TextInputType.text,
                        decoration: InputDecoration(
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.all(
