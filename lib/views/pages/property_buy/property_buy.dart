...
import 'package:home_land/views/pages/property_buy/property_buy_details/property_buy_details.dart';
import 'package:home_land/views/widgets/custom_text.dart';
import 'package:provider/provider.dart';

class PropertyBuy extends StatelessWidget {
  PropertyBuy({super.key, required this.landSellModel});
  final LandSellModel landSellModel;

  @override
  Widget build(BuildContext context) {
    final nid = context.read<UserProvider>();
    final newNid = '5105346703';
    print(newNid);
                    ...
                    return InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => PropertyBuyDetails(
                              landSellModel: landSellModel,
                              bankServerModel: userData),
                        ));
                      },
                      child: Card(
                              ...
                              Row(
                                children: [
                                  customTitleText('Branch Location: ',
                                      scaffoldBackgroundColor, 20),
                                  customTitleText(userData.Branch_Location,
                                      purpleColor, 15),
                                ],
                              ),
                              SizedBox(
